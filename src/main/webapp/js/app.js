var app = angular.module('exampleApp', ['ui.router','ngCookies','exampleApp.services', 'ngStorage'])
    .config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$httpProvider',
        function ($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
            ...
            $stateProvider
                ...
                .state('checkout-1',{
                	url:'/checkout-step-1',
                	templateUrl:'pages/checkout-step-1.html',
                })
                
                  .state('checkout-2',{
                	url:'/checkout-step-2',
                	templateUrl:'pages/checkout-step-2.html',
                })
                
                .state('checkout-3',{
                	url:'/checkout-step-3',
                	templateUrl:'pages/checkout-step-3.html',
                })
                
                 .state('checkout-4',{
                	url:'/checkout-step-4',
                	templateUrl:'pages/checkout-step-4.html',
                	controller:'cartController'
                }) 
            ...
            $httpProvider.interceptors
                .push(function ($q, $rootScope, $location,$log,$sessionStorage,$localStorage) {
                    return {
    ...
    function ($rootScope, $location, $cookieStore, UserService,
              $state,$sessionStorage,cityService) {
        // ------------ mock $http requests ---------------------
