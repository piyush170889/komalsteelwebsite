            ...
            <div class="col-xs-12">
              <div class="media">
                <div class="media-left productSlider">
				  ...
				  <iframe width="100%" height="220" src="https://www.youtube.com/embed/_5zDlwIu7DM" frameborder="1" allowfullscreen></iframe>
				  </div>
                </div>
                <div class="media-body">
                  
                  <h2 style="text-align:center;padding: 20px;border-bottom: 7px solid yellow;text-shadow: 2px -2px #000;background: #3E4095;color: #fff;font-weight: bold;margin-bottom: 0;padding:10px 20px;">STAINLESS STEEL OIL CAN (RED CAP)</h2>
				  <br/>
                  ...
                  <!--<span class="quick-drop">
                    <select name="guiest_id3" id="guiest_id3" class="select-drop">
					  ...
					  <option value="5">Sumo</option> 
                    </select>
                  </span>-->
				  <!--<span class="quick-drop">
                    <select name="guiest_id3" id="guiest_id3" class="select-drop">
                      <option value="0">Capacity</option>
                      <option value="1">450Ml</option>
                      <option value="2">550Ml</option>
                      <option value="3">750ml</option> 
					  <option value="4">1000Ml</option> 
					  <option value="5">1200</option> 
                    </select>
                  </span>-->
                  <!--<span class="quick-drop resizeWidth">
                    <select name="guiest_id4" id="guiest_id4" class="select-drop" style="overflow-y:scroll;height:100px;">
				  ...
				  <!------------------------------------->
						...
						<H3><u>Select to Order</u></H3>
							<table class="table">
							  ...
							  <div class="col-md-12">
							  <hr/>
							  <h5 style="background:whitesmoke;padding:20px 10px">Total Number of Items : 3 </h5>
							  <br/>
									  ...
									  <table class="table">
										<thead>
										  <tr>
											...
											<th style="paddnig:20px 0">Item Number</th>
											<th style="paddnig:20px 0">Quantity</th>
										  </tr>
										</thead>
										<tbody>
										  <tr>
										   
											<td style="paddnig:20px 0">001</td>
											<td style="paddnig:20px 0">10X8</td>
				...
				<!------------------------------------->
				 ...
				 <div class="col-md-6">
                    ...
                    <a href="index.php" class="btn btn-primary btn-block pull-right">Continue Shopping</a> 
					</div>
				 <div class="col-md-6">
				 
                    <a href="#" class="btn btn-primary btn-block pull-right">Add to cart <i class="fa fa-angle-right" aria-hidden="true"></i></a> 
					</div>
...
<!-- Mirrored from themes.iamabdus.com/bigbag/1.0/single-product.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Jul 2016 10:31:37 GMT -->
</html>