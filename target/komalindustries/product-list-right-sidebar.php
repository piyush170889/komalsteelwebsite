          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <ol class="breadcrumb pull-right">
                ...
                <li class="active">Product List Right Sidebar</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="row filterArea">
                ...
                <div class="col-xs-6">
                  <div class="btn-group pull-right" role="group">
                    <button type="button" class="btn btn-default" onclick="window.location.href='product-grid-right-sidebar.php'"><i class="fa fa-th" aria-hidden="true"></i><span>Grid</span></button>
                    <button type="button" class="btn btn-default active" onclick="window.location.href='product-list-right-sidebar.php'"><i class="fa fa-th-list" aria-hidden="true"></i><span>List</span></button>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from themes.iamabdus.com/bigbag/1.0/product-list-right-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Jul 2016 10:31:57 GMT -->
</html>